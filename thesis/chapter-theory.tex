...
\begin{figure}[ht]
	\begin{center}
		\subfigure[Distribution A\label{fig:chunkedswarmmodel1}]{
	 		\includegraphics[width=0.3\textwidth]{chunkedswarmmodel1}
	 	}
	 	\hspace{0.2\textwidth}
	 	\subfigure[Distribution B\label{fig:chunkedswarmmodel2}]{
	 		\includegraphics[width=0.3\textwidth]{chunkedswarmmodel2}
	 	}

		\subfigure[Complete Distribution\label{fig:chunkedswarmformula1}]{
	 		\includegraphics[width=0.9\textwidth]{chunkedswarmformula1}
	 	}
